		...
		<table class="table1">
			...
			<c:forEach items="${model.produits}" var="p">
				<tr>
					...
					<td>${p.quantite}</td>
					<td><a
						href="javascript:confirmer('controleur.php?action=delete&ref=${p.reference}')">
							Supprimer</a></td>
					<td><a href="controleur.php?action=edit&ref=${p.reference}">Edit
					</a></td>
				</tr>
			</c:forEach>
		</table>
			...
			<tr>
				...
				<tr>
					...
					<td><input type="text" name="designation"
						value="${model.produit.designation}" /></td>
					<td></td>
				</tr>
				<tr>
					<td>Prix:</td>
					<td><input type="text" name="prix"
						value="${model.produit.prix}" /></td>
					<td></td>
				</tr>
				<tr>
					<td>Quantité:</td>
					<td><input type="text" name="quantite"
						value="${model.produit.quantite }" /></td>
					<td></td>
				</tr>
				<tr>
